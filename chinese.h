...
#define F1Shrt      "F1\xA1\xA2"                  // F1短
#define F1Long      "F1\xA1\xA4"                  // F1长
#define F2Shrt      "F2\xA1\xA2"                  // F2短
#define F2Long      "F2\xA1\xA4"                  // F2长
#define MLong       "M\xA1\xA4"                   // M长
#define BatSav      "\x8C\x8D"                    // 省电
#define BatTxt      "\x8D\xBA\x93\x94"            // 电量显示
#define Mic         "Mic"                         // Mic
#define ChDisp      "\x1C\x1D\x93\x94"            // 信道显示
#define POnMsg      "\xC3\xC4\x93\x94"            // 开机
#define BLTime      "\x95\x96"                    // 背光
#define BLMax       "\x97\x98\xBC\xBD"            // 光亮
#define Beep        "\xA9\x0B"                    // 键音
#define Roger       "\x9B\x9C\x0B"                // 尾音
#define STE         "\x9C\x0B\x9D\x1F"            // 尾音消
#define RP_STE      "\x9E\x9F\xA0\x9C\x0B\x9D\x1F" // 中继尾音消
#define Call1       "\xA1\xA2"                    // 快捷
#define VOX         "VOX"                         // VOX
#define SysInf      "\xB5\xB6\xA7\xB8"            // 信息
#define BatVol      "\x8D\xBA"                    // 电压
#define SetPwr      "\xB7\xC1"                    // 功率
#define SetCtr      "\xBE\x07"                    // 对比
#define SetInv      "\xC7\xD0\xB1\xB8"            // 反色
#define SetLck      "\xC7\xD0\xD9\x0E\x0F"        // 锁定模式
